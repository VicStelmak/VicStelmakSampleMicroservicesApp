...
role based access control system and that is why only user in role Administrator can see all three panels on the left side. 
...
<br>
<div align="justify">
To compile application requires valid connection to User microservice database. I strongly encourage to use docker-compose for the sake of trying out
this application. 
</div>